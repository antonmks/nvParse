...
int main() {
	...
	thrust::device_vector<char> dev_res1(cnt*15); thrust::fill(dev_res1.begin(), dev_res1.end(), 0);
	thrust::device_vector<char> dev_res2(cnt*15); thrust::fill(dev_res2.begin(), dev_res2.end(), 0);
	thrust::device_vector<char> dev_res3(cnt*15); thrust::fill(dev_res3.begin(), dev_res3.end(), 0);
	thrust::device_vector<char> dev_res4(cnt*15); thrust::fill(dev_res4.begin(), dev_res4.end(), 0);
	thrust::device_vector<char> dev_res5(cnt*15); thrust::fill(dev_res5.begin(), dev_res5.end(), 0);
	thrust::device_vector<char> dev_res6(cnt*15); thrust::fill(dev_res6.begin(), dev_res6.end(), 0);
	thrust::device_vector<char> dev_res7(cnt*15); thrust::fill(dev_res7.begin(), dev_res7.end(), 0);
	thrust::device_vector<char> dev_res8(cnt*15); thrust::fill(dev_res8.begin(), dev_res8.end(), 0);
	thrust::device_vector<char> dev_res9(cnt); thrust::fill(dev_res9.begin(), dev_res9.end(), 0);
	thrust::device_vector<char> dev_res10(cnt); thrust::fill(dev_res10.begin(), dev_res10.end(), 0);
	thrust::device_vector<char> dev_res11(cnt*10); thrust::fill(dev_res11.begin(), dev_res11.end(), 0);
	...
	ind[6] = 6;ind[7] = 7;ind[8] = 8;
	ind[9] = 9;ind[10] = 10;
	
	thrust::device_vector<unsigned int> dest_len(11); //fields max lengths
	dest_len[0] = 15;dest_len[1] = 15;dest_len[2] = 15;
	dest_len[3] = 15;
	dest_len[4] = 15;dest_len[5] = 15;
	dest_len[6] = 15;dest_len[7] = 15;dest_len[8] = 1;
	dest_len[9] = 1;dest_len[10] = 10;
